...
const Footer = (props) => {
  ...
  const contacto = ["Contacto", "Redacción", "Empleo"];
  const legal = ["Términos y condiciones", "Política de seguridad"];
  ...
  return (
    <footer className={data.length < 1 ? "footer fixed-bottom" : "footer"}>
      <Row>
        <Col>
          <h4>En el mundo</h4>
          <ul className="world">
            {world.map((w) => (
              <li key={w.id}>
                <a
                  ...
                  href={`https://${w.id}.ficticia-news.com/`}
                >
                  {w.descripcion}
                </a>
              </li>
      ...
      <Row>
        ...
        <Col md="auto" className="separator">
          |
        </Col>
        <Col className="developedBy">
          ...
          <a
            className="link-light"
            href="https://chelocastillo1.github.io/informatorioPortfolio/"
            target="_blank"
            rel="noreferrer"
          >
            FICTICIA Software
